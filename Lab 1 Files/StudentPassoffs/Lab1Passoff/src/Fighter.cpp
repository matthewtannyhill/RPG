...
Fighter::Fighter(string name, int max_HP, int HP, int strength, int speed, int magic)
    {
        this->name = name;
        this->max_HP = max_HP;
        this->HP = max_HP;
    ...
    string Fighter::getName() const //FINSIHED..
    {
    ...
    */
    ...
    int Fighter::getMaximumHP() const //FINSIHED..
    {
    ...
    */
    ...
    int Fighter::getCurrentHP() const //FINSIHED..
    {
    ...
    */
    ...
    int Fighter::getStrength() const //FINSIHED..
    {
    ...
    */
    ...
    int Fighter::getSpeed() const //FINISHED..
    {
    ...
    */
    ...
    int Fighter::getMagic() const //FINSIHED..
    {
    ...
    */
    ...
    void Fighter::takeDamage(int damage) //FINISHED
    {
        if ((damage - (speed / 4)) >= 1)
        {
            HP = HP - (damage - (speed / 4));
        }
        else
        {
            HP = HP - 1;
    ...
    */
    ...
    void Fighter::regenerate() //FINISHED
    {
        if(strength / 6 >= 1)
        {
        HP = HP + strength / 6;
